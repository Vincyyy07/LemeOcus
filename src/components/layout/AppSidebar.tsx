      ...
      >
        ...
        <div className="px-3 pb-4 space-y-1.5 relative z-10">
          ...
          <a
            ...
            className={cn(
              "flex items-center gap-3 px-3 py-2.5 rounded-xl text-muted-foreground hover:text-primary transition-all duration-200 group relative overflow-hidden",
              collapsed && "justify-center"
            )}
            title="Developer GitHub"
          >
            <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-primary/10" />
            <svg
              className={cn(
                "w-4 h-4 relative z-10 shrink-0 transition-colors duration-200 group-hover:text-primary",
                collapsed ? "text-muted-foreground/60" : "text-muted-foreground"
              )}
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
            ...
            <AnimatePresence>
              {!collapsed && (
                <motion.span
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="text-xs font-semibold relative z-10 group-hover:text-primary flex items-center gap-1.5"
                >
                  Built by Vincyyy07 <span className="text-[10px] text-muted-foreground/60 group-hover:text-primary/70">⚡</span>
                </motion.span>
              )}
            </AnimatePresence>
          </a>
